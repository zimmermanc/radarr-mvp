...
mod integration_tests {
    use crate::{AddTorrentParams, QBittorrentClient, QBittorrentConfig, TorrentData};
    ...
    async fn test_qbittorrent_download() {
        ...
        assert!(
            initial_torrents.is_ok(),
            "Failed to get initial torrents: {:?}",
            initial_torrents
        );
