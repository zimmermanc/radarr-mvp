...
impl TmdbListClient {
    ...
    fn movie_to_list_item(&self, movie: radarr_core::Movie) -> ListItem {
        ...
        ListItem {
            ...
            original_language: tmdb_metadata["original_language"]
                .as_str()
                .map(String::from),
