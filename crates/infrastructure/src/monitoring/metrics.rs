...
impl PrometheusMetrics {
    ...
    pub async fn record_queue_metrics(
        &self,
        queue_name: &str,
        depth: u64,
    ...
    pub async fn generate_prometheus_output(&self) -> String {
        ...
        add_metric_header(
            &mut output,
            &format!("{}_sync_operations_total", subsys),
        ...
        add_metric_header(
            &mut output,
            &format!("{}_sync_operations_success_total", subsys),
        ...
        for (labels, value) in sync_success.iter() {
            output.push_str(&format!(
                "{}_{}_sync_operations_success_total{{{}}} {}\n",
                ns, subsys, labels, value
            ));
        }
        ...
        add_metric_header(
            &mut output,
            &format!("{}_sync_operations_failed_total", subsys),
        ...
        for (labels, value) in sync_failed.iter() {
            output.push_str(&format!(
                "{}_{}_sync_operations_failed_total{{{}}} {}\n",
                ns, subsys, labels, value
            ));
        }
        ...
        add_metric_header(
            &mut output,
            &format!("{}_api_requests_total", subsys),
        ...
        add_metric_header(
            &mut output,
            &format!("{}_api_rate_limit_hits_total", subsys),
        ...
        add_metric_header(
            &mut output,
            &format!("{}_cache_hits_total", subsys),
        ...
        add_metric_header(
            &mut output,
            &format!("{}_cache_misses_total", subsys),
        ...
        add_metric_header(
            &mut output,
            &format!("{}_circuit_breaker_failures", subsys),
        ...
        add_metric_header(
            &mut output,
            &format!("{}_last_successful_sync_timestamp", subsys),
        ...
        for (labels, timestamp) in last_syncs.iter() {
            output.push_str(&format!(
                "{}_{}_last_successful_sync_timestamp{{{}}} {}\n",
                ns,
                subsys,
                labels,
                timestamp.timestamp()
...
mod tests {
    ...
    async fn test_record_sync_operation() {
        ...
        metrics
            .record_sync_operation("imdb", true, Duration::from_millis(1500))
            .await;

        // Record failed operation
        metrics
            .record_sync_operation("imdb", false, Duration::from_millis(500))
            .await;
    ...
    async fn test_record_api_request() {
        ...
        metrics
            .record_api_request("tmdb", Duration::from_millis(100), true)
            .await;
    ...
    async fn test_prometheus_output_generation() {
        ...
        // Record some metrics
        metrics
            .record_sync_operation("imdb", true, Duration::from_millis(1000))
            .await;
        metrics
            .record_api_request("tmdb", Duration::from_millis(200), false)
            .await;
