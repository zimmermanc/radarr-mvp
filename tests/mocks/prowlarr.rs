...
use radarr_indexers::{
    models::{
        Category, IndexerCapabilities, IndexerStats, IndexerStatus, ProwlarrIndexer,
        ProwlarrSearchResult, SearchRequest, SearchResponse,
    },
...
impl Default for MockProwlarrClient {
    fn default() -> Self {
        ...
        let indexers = vec![ProwlarrIndexer {
            id: 1,
            ...
            categories: vec![
                ...
                Category {
                    id: 2030,
                    name: "Movies/SD".to_string(),
                    description: None,
                },
                Category {
                    id: 2040,
                    name: "Movies/HD".to_string(),
                    description: None,
                },
            ],
