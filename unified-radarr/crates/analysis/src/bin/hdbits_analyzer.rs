...
use radarr_rust::core::hdbits::HDBitsConfig;
use radarr_rust::core::scene_group_data_collector::SceneGroupDataCollector;
...
async fn main() -> Result<()> {
    ...
    let mut collector = SceneGroupDataCollector::new(config, output_dir);
